import { ICarBrand } from "../car-brands/car-brands.model";
import { IRentedCar } from "../rented-cars/rented-cars.model";

export const rentedCars: IRentedCar[] = [
  {
    model: 'Astra',
    brand: 'Opel',
    registrationNumber: 'WAW1234',
    vin: 'AAAAABBBBBCCCCC01',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
  ...
  },
  {
    model: 'Corsa',
    brand: 'Opel',
    registrationNumber: 'WAW4321',
    vin: 'AAAAABBBBBCCCCC02',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
  ...
  },
  {
    model: 'Focus',
    brand: 'Ford',
    registrationNumber: 'WAW5678',
    vin: 'AAAAABBBBBCCCCC03',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
  ...
  },
  {
    model: 'Mondeo',
    brand: 'Ford',
    registrationNumber: 'WAW8765',
    vin: 'AAAAABBBBBCCCCC04',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
  ...
  },
  {
    model: 'Civic',
    brand: 'Honda',
    registrationNumber: 'WAW9876',
    vin: 'AAAAABBBBBCCCCC05',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
    ...
    rented: true,
    email: 'cersei.lannister@queen.lion',
    clientAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '3',
  ...
  },
  {
    model: 'Accord',
    brand: 'Honda',
    registrationNumber: 'WAW6789',
    vin: 'AAAAABBBBBCCCCC06',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
  ...
  },
  {
    model: 'Passat',
    brand: 'Volkswagen',
    registrationNumber: 'WAW7890',
    vin: 'AAAAABBBBBCCCCC07',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
    ...
    rented: true,
    email: 'eddard.stark@winter.iscoming',
    clientAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '3',
  ...
  },
  {
    model: 'Golf',
    brand: 'Volkswagen',
    registrationNumber: 'WAW8901',
    vin: 'AAAAABBBBBCCCCC08',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
  ...
  },
  {
    model: 'Clio',
    brand: 'Renault',
    registrationNumber: 'WAW9012',
    vin: 'AAAAABBBBBCCCCC09',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
    ...
    rented: true,
    email: 'stannis.baratheon@night.dark',
    clientAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '3',
  ...
  },
  {
    model: 'Megane',
    brand: 'Renault',
    registrationNumber: 'WAW0123',
    vin: 'AAAAABBBBBCCCCC10',
    currentAddress: {
      city: 'Warsaw',
      street: 'Krucza',
      houseNumber: '1',
